...
Deze zelfstudie geeft een overzicht van de belangrijkste functies voor beheer en gegevensbeheer van Campaign v8. Het is bedoeld voor beheerders en technische marketingmedewerkers die migreren van Campaign Standard naar Campaign v8.
...
2. Leer hoe u gebruikersmachtigingen beheert in de clientconsole. Leer hoe u
   ...
   * Gebruikers toevoegen via Admin Console
   * Productprofielen instellen
   * Operatorgroepen maken en benoemde rechten toewijzen
   * Productprofielen toewijzen ⇄ groepen met operatoren
